...
##GUILE_LOAD_PATH provided by scripts
##echo export GUILE_LOAD_PATH="${GUILE_LOAD_PATH:+:}$GUILE_LOAD_PATH" >> $HOME/.bashrc
##echo export GUILE_DBD_PATH="${GUILE_DBD_PATH:+:}$GUILE_DBD_PATH" >> $HOME/.bashrc
