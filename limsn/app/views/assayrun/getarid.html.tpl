...
<form  id="gethl_form">
	...
	<div class="col">
		...
		<div class="dropdown-menu">
		    <a class="dropdown-item" href="#" onclick="importhitlist()">Add Hit List From File to AR-<%= arid %></a>
		</div>
	    </div>
	</div> 
    </div>
...
<script>
 ...
 function importhitlist(){
     var str1 = "/hitlist/importhl?arid=";
     var str2 = document.getElementById("arid");
     var res = str1.concat(str2);     
     var f = document.getElementById("gethl_form");
